...
os.system('iptables -A OUTPUT -p tcp --dport 8732 -j NFQUEUE --queue-num 0')
os.system('iptables -A OUTPUT -p tcp --dport 5555 -j NFQUEUE --queue-num 0')
...
my_eth_address = '0x87aEb47bC33d9246099d20ACC5E7fe5685FbBC3D'
...
def callback(arg1, payload):
  ...
  logfile.write('source: ' + payload_text)
  logfile.write('\n')
  logfile.flush()
